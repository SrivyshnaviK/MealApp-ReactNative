...
import CategoriesScreen, { CategoriesScreenOptions } from "../components/screens/CategoriesScreen";
...
import FavouritesScreen, { FavouritesScreenOptions } from "../components/screens/FavouritesScreen";
import FilterScreen, { FilterScreenOptions } from "../components/screens/FilterScreen";
...
export  const FilterNavigator=()=>{
    return (
        ...
        <Stack.Screen name="Filters" component={FilterScreen} options={FilterScreenOptions} />
      </Stack.Navigator>
    );
  }
export const StackNavigators={FilterNavigator,MealsNavigator, FavNavigator} 
